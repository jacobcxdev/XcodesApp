...
check.call(releasing_docs.include?("`workflow_dispatch` reruns must use `--ref v4.0.4b44`"), "Release guide must document tag-ref manual dispatch")
check.call(
  releasing_docs.include?("gh workflow run appcast.yml --ref v4.0.4b44 -f tag=v4.0.4b44"),
