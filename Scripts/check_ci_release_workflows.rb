...
check.call(releasing_docs.include?("`workflow_dispatch` reruns must use `--ref v4.1.1b49`"), "Release guide must document tag-ref manual dispatch")
check.call(
  releasing_docs.include?("gh workflow run appcast.yml --ref v4.1.1b49 -f tag=v4.1.1b49"),
